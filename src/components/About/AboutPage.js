    ...
    <>
      <header className="header">
        <h1 className="header__title">
          About Our Bond Ratio Analysis Software
        </h1>
      </header>
      ...
      <section className="section">
        ...
        <ul className="section__list">
          <li className="section__item">
            <strong className="section__item-title">
              Bond Ratio Calculation:
            </strong>{' '}
          ...
          <li className="section__item">
            <strong className="section__item-title">Trading Signals:</strong>{' '}
            Our software doesn't stop at just calculations. It goes a step
            further by generating trading signals based on the results of bond
            ratio analysis and standard deviation. These signals can help you
      ...
      <section className="section">
        ...
        <ol className="section__list">
          ...
          <li className="section__item">
            ...
            The software calculates various ratios between the two bonds,
            revealing their historical performance relative to each other.
          </li>
          <li className="section__item">
            <strong className="section__item-title">Standard Deviation:</strong>{' '}
          ...
          <li className="section__item">
            <strong className="section__item-title">Signal Generation:</strong>{' '}
          ...
          <li className="section__item">
            <strong className="section__item-title">Visualizations:</strong> The
      ...
      <section className="section">
        ...
        <ul className="section__list">
          ...
          <li className="section__item">
            <strong className="section__item-title">Risk Management:</strong>{' '}
            Assess the level of risk in your portfolio and take proactive steps
            to manage it based on the standard deviation analysis.
          </li>
          <li className="section__item">
            <strong className="section__item-title">Market Monitoring:</strong>{' '}
      ...
      <section className="section">
        <h2 className="section__title">Reliability</h2>
        <p className="section__content">
